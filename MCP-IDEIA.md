# Ideia de Servidor MCP — EQ08

**Domínio:** Gestão de pequenos negócios (FastAPI)  
**Data:** 2026-07-01
...
## Servidor proposto: `gestor-mcp`

### Tools sugeridas

- `resumo_financeiro(periodo)` — receita/despesa
- `cadastrar_venda(itens, valor)` — registra venda
- `itens_estoque_baixo()` — alerta de estoque
- `relatorio(periodo)` — relatório gerencial

### Resources (somente leitura)

- relatório de vendas como resource

### Exemplos de uso com um LLM

- "Como foi o faturamento do mês e o que está acabando no estoque?"
